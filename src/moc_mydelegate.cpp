...
QT_MOC_LITERAL(1, 11, 7), // "endEdit"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 20) // "CommitAndCloseEditor"

    },
    "MyDelegate\0endEdit\0\0CommitAndCloseEditor"
};
...
void MyDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MyDelegate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyDelegate::endEdit)) {
                *result = 0;
                return;
            }
        }
